...
public enum ToolType {
    ...
    IMPORTPNG(
			...
			R.string.help_content_import_png, false, EnumSet.of(StateChange.ALL)),
    CROP(R.string.button_crop,
			R.drawable.icon_menu_crop, R.string.help_content_crop, false,
			EnumSet.of(StateChange.RESET_INTERNAL_STATE,
					StateChange.NEW_IMAGE_LOADED)),
    ERASER(R.string.button_eraser, R.drawable.icon_menu_eraser,
		    R.string.help_content_eraser, false, EnumSet.of(StateChange.ALL)),
    FLIP(R.string.button_flip, R.drawable.icon_menu_flip_horizontal,
			R.string.help_content_flip, false, EnumSet.of(StateChange.ALL)),
    RECT(R.string.button_rectangle, R.drawable.icon_menu_rectangle,
			R.string.help_content_rectangle, true, EnumSet.of(StateChange.ALL)),
    MOVE(R.string.button_move, R.drawable.icon_menu_move,
			R.string.help_content_move, false, EnumSet.of(StateChange.ALL)),
    ROTATE(R.string.button_rotate, R.drawable.icon_menu_rotate_left,
			R.string.help_content_rotate, false, EnumSet.of(StateChange.ALL)),
    TEXTTOOL(
            R.string.button_texttool, R.drawable.icon_menu_texttool,
            R.string.help_content_texttool, false, EnumSet.of(StateChange.ALL)),
    REPLACECOLORTOOL(
            R.string.button_replacecolortool,R.drawable.icon_menu_replacecolortool,
            R.string.help_content_replacecolor, true, EnumSet.of(StateChange.ALL));
	...
	ToolType(int nameResource, int imageResource, int helpTextResource,
