...
import org.catrobat.paintroid.command.implementation.ReplaceColorCommand;
import org.catrobat.paintroid.dialog.IndeterminateProgressDialog;
import org.catrobat.paintroid.tools.ToolType;
import org.catrobat.paintroid.ui.TopBar.ToolButtonIDs;

public class ReplaceColorTool extends BaseTool {

    public ReplaceColorTool(Context context, ToolType toolType) {
    ...
    public boolean handleUp(PointF coordinate) {
        ...
        Command command = new ReplaceColorCommand(new Point((int) coordinate.x,
                (int) coordinate.y), mBitmapPaint);

        IndeterminateProgressDialog.getInstance().show();
        ((ReplaceColorCommand) command).addObserver(this);
